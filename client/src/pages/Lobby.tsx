...
export function Lobby() {
  ...
  const [seats, setSeats] = useState(meta.seatOptions[0]);
  ...
  useEffect(() => {
    setSeats(GAME_META[game].seatOptions[0]);
  }, [game]);
        ...
        <div>
          ...
          <div className="create">
            ...
            <label style={{ display: "flex", gap: 8, alignItems: "center", color: "var(--mist)", fontSize: 14 }}>
              ...
              Fill empty chairs with computers (partners sit opposite / alternate)
            </label>
            ...
            {open.length === 0 ? (
              ...
              open.map((t) => (
                <div className="table-row" key={t.id}>
                  <div>
                    <strong>{GAME_META[t.game].title}</strong>
                    <div className="mono" style={{ color: "var(--mist)", fontSize: 12 }}>
                      {t.code} · {t.filled}/{t.seats} · {t.phase}
                    </div>
                  </div>
