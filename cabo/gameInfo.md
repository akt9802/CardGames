The Cabo card game
Jun 4th, 2015 11:30 am | Comments
...
Cabo did not have a Wikipedia article when I first learned about it and I couldn’t find anything online about it. There is now a Wikipedia entry for Cabo and I ran across a website selling special Cabo playing cards: playcabo.com (now offline).
...
The official rules are significantly different from the version I play by and I find my version significantly more fun. However, the official version is fun and it’s definitely simpler to pick up (especially for kids). If you want a deck custom-built for Cabo and you’d like to play by the official rules, you can [buy a deck here][] (previously Eventide Games LLC sold them at PlayCabo.com).
